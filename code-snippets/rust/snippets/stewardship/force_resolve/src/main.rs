...
fn main() -> SzResult<()> {
    ...
    if entity_id1 == entity_id2 {
        ...
        println!("Entity {}: {}", entity_id1, get_entity_summary(&entity1_json)?);
        println!("Entity {}: {}", entity_id2, get_entity_summary(&entity2_json)?);
        ...
        let reload_info = engine.add_record("TEST", "FORCE_RESOLVE_1", record1, Some(force_flags))?;
        ...
        println!("Entity {}: {}", entity_id1, get_entity_summary(&final_entity1)?);
        println!("Entity {}: {}", entity_id2, get_entity_summary(&final_entity2)?);
    }
